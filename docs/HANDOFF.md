...
- **本机**：D1/D2 已升级为满血版（fa9692961a471b7a1421a05a2656b0a1 = 本地 dist/win-unpacked 拷贝，2026-08-20 装，含 docx→MD 修复 + 解锁模块，UI 版本号显示满血线 0.5.2）；桌面满血版匿名 zip 已重打（含 docx→MD 修复，md5 1f335ccc1c4f2e614dae2c82bece7f97）
